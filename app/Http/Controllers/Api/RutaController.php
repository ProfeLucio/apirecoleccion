 ...
 * description="Crea una ruta a partir de una geometría GeoJSON o uniendo las geometrías de una lista de IDs de calles. Es obligatorio enviar uno de los dos: 'shape' O 'calles_ids'.",
 * tags={"Rutas"},
 * @OA\RequestBody(
 * required=true,
 * @OA\JsonContent(
 ...
 * // Usamos comillas dobles para que el parser no se confunda con las comillas simples de PHP
