...
Route::post('recorridos/posiciones/{posicion_id}/imagen', [RecorridoController::class, 'subirImagenPosicion']);
Route::get('recorridos/posiciones/{posicion_id}/imagen', [RecorridoController::class, 'getImagenPosicion']);
